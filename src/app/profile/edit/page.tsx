    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const uploadImage = async (dataUri: string, bucketPath: 'avatars' | 'banners'): Promise<string> => {
                const imageRef = storageRef(storage, `${bucketPath}/${user.uid}/${uuidv4()}.jpg`);
            ...
            const firestoreUpdateData = {
                ...
                searchableHandle: (profileData.handle.startsWith('@') ? profileData.handle.substring(1) : profileData.handle).toLowerCase(),
            };
