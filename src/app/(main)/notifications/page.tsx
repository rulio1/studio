        ...
        <li className={`p-4 flex gap-4 hover:bg-muted/50 cursor-pointer ${!notification.read ? 'bg-primary/5' : ''}`} onClick={handleItemClick}>
            ...
            <div className="flex-1">
                ...
                <p>
                    ...
                    {isZisprAccount ? <Bird className="inline-block h-4 w-4 text-primary ml-1" /> : (isVerified && <BadgeCheck className={`inline-block h-4 w-4 ${isRulio ? 'text-white fill-primary' : badgeColor} ml-1`} />)}
